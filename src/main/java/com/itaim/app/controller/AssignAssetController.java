package com.itaim.app.controller;
...
import com.itaim.app.serviceImpl.AssignAssetServiceImpl;
...
public class AssignAssetController {
	...
	public void deleteAssetById(@PathVariable int id) throws Exception {
		Optional<AssignAsset> asset = service.getAssetById(id);
		if (!asset.isPresent())
			throw new Exception("Could not find asset with id- " + id);
